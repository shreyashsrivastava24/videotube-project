...
const uploadOnCloudinary = async (localFilePath) => {
    try {
        ...
        //upload hone k baad jo public url mil gya
        //console.log("file is uploaded on cloudinary ", response.url);
        //user ko response return kr diya
        ...
        fs.unlinkSync(localFilePath) // remove the locally saved temporary file as the upload operation got failed otherwaise malicious,corrupted files reh jayengi server pe
        return null;
    }
}
